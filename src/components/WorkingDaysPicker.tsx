...
export default function WorkingDaysPicker({ value, onChange }: WorkingDaysPickerProps) {
    ...
    return (
        <div className="space-y-3">
            <div className="flex items-center gap-2 text-slate-500 dark:text-[var(--app-muted)] text-xs font-medium">
                    ...
                    return (
                        <button
                            ...
                            className={`px-4 py-2 rounded-xl text-sm font-bold transition-all ${isSelected
                                    ...
                                    : 'bg-slate-100 dark:bg-[var(--app-surface-2)] text-slate-400 dark:text-[var(--app-muted)] hover:bg-slate-200 dark:hover:bg-[var(--app-surface-2)]'
                                }`}
                        >
                            {day.short}
                        </button>
